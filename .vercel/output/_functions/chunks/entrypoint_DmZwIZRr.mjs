import { R as ROUTE_TYPE_HEADER, i as REROUTE_DIRECTIVE_HEADER, j as bold, k as red, y as yellow, l as dim, n as blue, o as decryptString, p as createSlotValueFromString, r as renderTemplate, g as renderComponent, D as DEFAULT_404_COMPONENT, q as renderSlotToString, t as renderJSX, u as chunkToString, v as isRenderInstruction, w as clientLocalsSymbol, x as clientAddressSymbol$1, A as ASTRO_VERSION, z as responseSentSymbol$1, B as renderPage, C as REWRITE_DIRECTIVE_HEADER_KEY, E as REWRITE_DIRECTIVE_HEADER_VALUE, F as renderEndpoint, G as REROUTABLE_STATUS_CODES, H as getAugmentedNamespace, I as commonjsGlobal } from './astro/server_BjSn9fij.mjs';
import { g as getActionQueryString, d as deserializeActionResult, e as ensure404Route, a as default404Instance, D as DEFAULT_404_ROUTE } from './astro-designed-error-pages_CTm9eF33.mjs';
...
function compile$3(str, options) {
    return tokensToFunction$1(parse$5(str, options), options);
}
/**
...
function stringToRegexp$1(path, keys, options) {
    return tokensToRegexp$1(parse$5(path, options), keys, options);
}
/**
...
function compile$2(str, options) {
    return tokensToFunction(parse$4(str, options), options);
}
/**
 * Expose a method for transforming tokens into the path function.
 */
...
function requireAppend () {
	if (hasRequiredAppend) return append$1;
	hasRequiredAppend = 1;
	...
	append$1 = __toCommonJS(append_exports);
